...
public class UnLoad extends ActionBiComp<Map<String, Object>, AbstractBaseController.FormReturnEnum> {
    ...
    public UnLoad(Consumer<Map<String, Object>> preCallback, Consumer<AbstractBaseController.FormReturnEnum> postCallback) {
        this();
