...
public class OutFile extends ActionBiComp<Map<String, Object>, AbstractBaseController.FormReturnEnum> {
    ...
    public OutFile(Consumer<Map<String, Object>> preCallback, Consumer<AbstractBaseController.FormReturnEnum> postCallback) {
        this();
