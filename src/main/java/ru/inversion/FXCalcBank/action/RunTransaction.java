...
public class RunTransaction extends ActionBiComp<Map<String, Object>, AbstractBaseController.FormReturnEnum> {
        ...
        public RunTransaction(Consumer<Map<String, Object>> preCallback, Consumer<AbstractBaseController.FormReturnEnum> postCallback) {
            this();
